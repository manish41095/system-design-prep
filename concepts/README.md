...
| Latency, throughput, availability and SLOs | High | Learning | 3/5 | 2026-09-25 | Separate API, provider-submission and end-to-end SLOs in [Mock 03](../practice/mocks/2026-09-25-notification-system-attempt-01.md) |
...
| SQL vs NoSQL and data-model trade-offs | High | Can explain | 3/5 | 2026-09-25 | Defend the notification store using access patterns and outbox needs |
...
| Delivery semantics, retries and DLQ | High | Can explain | 3/5 | 2026-09-25 | Add retry classification, jitter and safe DLQ replay |
| Idempotency and transactional outbox | High | Learning | 2/5 | 2026-09-25 | Explain durable API idempotency and transactional outbox crash cases |
...
| Capacity planning, load testing and bottlenecks | High | Can explain | 4/5 | 2026-09-25 | Add replication, index and retention overhead to the 182 TB estimate |

...
| 03 | 2026-09-25 | [Notification system — attempt 01](2026-09-25-notification-system-attempt-01.md) | HLD | 37/50 | Lean Hire; core flow complete, reliability gaps remain | 2026-10-05 |

## Naming

Use **YYYY-MM-DD-problem-attempt-NN.md**.
...
1. Save the candidate answer before feedback.
2. Mark whether the evaluator was a person, ChatGPT or self-review.
3. Scores require evidence from the transcript/design/code.
4. Copy the top three gaps to the main [error log](../README.md#error-log).
